...
#define PLAIN_TEXT_FILE_PATH "./Sample/PlainText1_Decrypted.txt"
...
int main()
{
    ...
    std::cout << "Calculating Plain Text...\n";
    d.calcPlainText();
    std::cout << "Plain Text computed successfully\n";
    std::cout << "Storing Plain Text in " << PLAIN_TEXT_FILE_PATH << "...\n";
    d.printPlainText();
    std::cout << "Plain Text stored successfully\n";
    return 0;
}